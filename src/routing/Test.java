...
import routing.ENCPRelay.SprayListElement;
import core.*;
...
public class Test implements RoutingDecisionEngine
{
	...
	public void doExchangeForNewConnection(Connection con, DTNHost peer)
	{
		...
		for(Message m:me.getMessageCollection())
			if(((DecisionEngineRouter)me.getRouter()).startTransfer(m, con)==MessageRouter.RCV_OK)
			{
				return;
			}				
